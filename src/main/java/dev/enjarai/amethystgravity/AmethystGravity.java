package dev.enjarai.amethystgravity;

import dev.enjarai.amethystgravity.armor.GravityGlassesArmorMaterial;
import dev.enjarai.amethystgravity.block.CylinderFieldGeneratorBlock;
import dev.enjarai.amethystgravity.block.FieldGeneratorBlock;
import dev.enjarai.amethystgravity.block.PlanetFieldGeneratorBlock;
import dev.enjarai.amethystgravity.block.PlatingBlock;
import dev.enjarai.amethystgravity.block.entity.CylinderFieldGeneratorBlockEntity;
...
import dev.enjarai.amethystgravity.block.entity.PlatingBlockEntity;
import dev.enjarai.amethystgravity.block.ui.AbstractFieldGeneratorScreenHandler;
import dev.enjarai.amethystgravity.block.ui.CylinderFieldGeneratorScreenHandler;
import dev.enjarai.amethystgravity.block.ui.FieldGeneratorScreenHandler;
import dev.enjarai.amethystgravity.block.ui.PlanetFieldGeneratorScreenHandler;
import dev.enjarai.amethystgravity.gravity.GravityData;
import dev.enjarai.amethystgravity.item.EnchantedBlockItem;
